...
const HR_TABLE_COLUMNS = "minmax(150px, 1fr) 100px 220px";
...
export default function AdminHome() {
  ...
  const [form, setForm] = useState({
    role: "hr", fullName: "", email: "", password: "", pmCode: "",
  ...
  async function createUser(event) {
    ...
    try {
      ...
      setForm({ role, fullName: "", email: "", password: "", pmCode: "", pmId: "", internId: "", startDate: "", endDate: "", department: "", mentor: "", stipend: "" });
  ...
  const userTableLabels = activeTab === "intern"
    ...
    : activeTab === "pm" ? ["User", "PM Code", "Status", "Actions"] : ["User", "Status", "Actions"];
          ...
          <>
            ...
            {passwordModal && (
              <div onClick={() => setPasswordModal(null)} style={{ position: "fixed", inset: 0, background: "rgba(2,6,23,0.8)", backdropFilter: "blur(4px)", display: "grid", placeItems: "center", zIndex: 1300, padding: 20 }}>
                <div onClick={(e) => e.stopPropagation()} style={{ width: "100%", maxWidth: 440, background: "#0b1a24", border: `1px solid ${COLORS.borderGlass}`, borderRadius: 16, padding: 24, display: "flex", flexDirection: "column", gap: 16 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
